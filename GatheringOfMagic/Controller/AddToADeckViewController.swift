...
class AddToADeckViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        button.sizeToFit()
        let tapGesture = IndexPathDeckCustomTapGestureRecognizer(target: self,
                                                    action: #selector(addCardToThisDeck(sender:)))
    ...
    @objc func addCardToThisDeck(sender: IndexPathDeckCustomTapGestureRecognizer) {
        print(sender.index ?? "nop")
    }
...
class IndexPathDeckCustomTapGestureRecognizer: UITapGestureRecognizer {
    var index: Int?
}
